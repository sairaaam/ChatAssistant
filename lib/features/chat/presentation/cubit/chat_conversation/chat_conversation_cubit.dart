...
class ChatConversationCubit extends Cubit<ChatConversationState> {
  ...
  void clearConversations() {
    _chatMessages.clear(); // Clear the list of messages
    emit(ChatConversationLoaded(chatMessages: [])); // Emit an empty list
  }
}
